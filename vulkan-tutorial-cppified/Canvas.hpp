...
Canvas8bitRGBA
draw_checkerboard(const Pixel8bitRGBA color, const uint32_t size, Canvas8bitRGBA&& canvas)
{
...
decltype(auto) draw_checkerboard(const Pixel8bitRGBA color, const uint32_t size)
{
	return [=] (Canvas8bitRGBA&& canvas) 
	{
